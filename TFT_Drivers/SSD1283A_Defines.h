...
#define TFT_CASET   0x45 //Vertical RAM address position
#define TFT_PASET   0x44 //Horizontal RAM address position
#define TFT_RAMWR   0x22 //Write Data to GRAM
